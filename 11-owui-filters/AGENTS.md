...
- **Algorithme Clé** : Il est responsable de la création dynamique et de l'injection complète de l'arborescence du Framework (dossiers virtuels Codex, RAG, uploads, n8n_workflows) en distinguant les Domaines Globaux (`get_echo_global_path`) et les Domaines de Session (`get_echo_session_path`) dès la première interaction de l'utilisateur avec l'API WebUI.
